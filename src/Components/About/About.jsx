...
>
  Watch Intro
    ...
    {/* end of about first part  */}
      ...
      {/* About Content */}
      {showMore && (
        <div className="bg-black text-white font-aldrich py-[5%]">
          {/* Navigation Tabs */}
          ...
          {activeSection === 'education' && (
            <div className="mt-8 font-aldrich">
              {/* Education Content */}
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 justify-between space-y-8 md:space-y-0 md:space-x-8 px-[4%]">
                <div>
